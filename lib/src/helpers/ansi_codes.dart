...
class Mod {
  ...
  static Mod instance = Mod._();

  Ansi16Code reset = Ansi16Code(
    on: 0,
    off: 0,
  );
  Ansi16Code bold = Ansi16Code(
    off: 22,
    on: 1,
  );
  Ansi16Code dim = Ansi16Code(
    off: 22,
    on: 2,
  );
  Ansi16Code italic = Ansi16Code(
    off: 23,
    on: 3,
  );
  Ansi16Code underline = Ansi16Code(
    off: 24,
    on: 4,
  );
  Ansi16Code overline = Ansi16Code(
    off: 55,
    on: 53,
  );
  Ansi16Code hidden = Ansi16Code(
    off: 28,
    on: 8,
  );
  Ansi16Code strikeThrough = Ansi16Code(
    off: 29,
    on: 9,
  );
}
...
class Color {
  ...
  Ansi16Code blackWite = Ansi16Code(
    on: 30,
    off: COLOR_CLOSE,
  );
  ...
  Ansi16Code gray = Ansi16Code(
    on: 90,
    off: COLOR_CLOSE,
  );
  Ansi16Code grey = Ansi16Code(
    on: 90,
    off: COLOR_CLOSE,
  );
}
